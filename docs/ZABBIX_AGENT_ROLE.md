...
* `zabbix_agent_become_user_on_localhost`: optional parameter that if included and `zabbix_agent_become_on_localhost` is set to true, will attempt to install packages locally via this user instead of root
